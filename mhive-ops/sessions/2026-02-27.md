...
## Remaining / TODO
- **Anthropic API Key** — not in 1Password vault. Once added as "Anthropic API Key", uncomment in templates + compose files and re-inject
- **Brave Search** — token expired/invalid. Need valid subscription
